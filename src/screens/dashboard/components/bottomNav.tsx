              ...
              React.Children.map(children,  (child,i) => {
                const imgSrc = selectedIndex === i && showIcon ?
                  ...
                  <TouchableHighlight
                    ...
                    onPress={() => {this.update(i); child.props.onPress && child.props.onPress()}}
                  >
                    <View>
                      {selectedIndex === i && <Animated.View style={[animatedStyle]}>
                        {imgSrc}
                      </Animated.View> }
                      { selectedIndex !== i && imgSrc }
                    </View>
                  </TouchableHighlight>
                );
              })
